/*
	...
	문제: 우리는 사람의 덩치를 키와 몸무게, 이 두 개의 값으로 표현하여 그 등수를 메겨보려고 한다.
	   ...
	   -----------------------------
		...
		위 경우에 3등과 4등은 존재하지 않는다. 여러분은 N명 학생들의 몸무게와 키가 담긴 입력파일을 읽어서 
		각 사람들의 덩치 등수를 계산하여 출력해야 한다.
...
/*
		한 줄 정리
	먼저 sum[]을 n크기 만큼의 배열을 만들고, 모든 원소를 n으로 초기화한다.
	...
	이중 for문을 사용하여 하나 하나 다 비교해본다. 비교하면서 자신보다 크지 않다면 sum[i]의 값을 -1한다. 
*/
